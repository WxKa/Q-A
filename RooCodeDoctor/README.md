...
* podobnie jest z write_to_file, search_file, list_files, tych funkcji jest kilka i są to podstawowe funkcje dostępu do plików, czyli LLM'y mają tak zwaną wersję 'MCP dla ubogich' i dlatego to działa.
